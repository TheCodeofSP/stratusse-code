...
export default function ObserverToCreator() {
  ...
  return (
    <>
      <SEO
        title={seoContent.pages.observerToCreator.title}
        description={seoContent.pages.observerToCreator.description}
        image={seoContent.pages.observerToCreator.image}
        url={`${seoContent.site.url}/observer-to-creator`}
      />
